...
\subsection*{Delete G}
\subsubsection*{Borrow N from Right Child}
\begin{tikzpicture}[level/.style={sibling distance=50mm/#1}]
    \node[rectangle, draw]{N}
        child {node[rectangle, draw]{EG}
            child {node[rectangle, draw]{B C}}
            child {node[rectangle, draw]{F}}
            child {node[rectangle, draw]{H K}}
        }
...
\subsubsection*{Delete F from Leaf}
\begin{tikzpicture}[level/.style={sibling distance=50mm/#1}]
    \node[rectangle, draw]{N}
        child {node[rectangle, draw]{CH}
            child {node[rectangle, draw]{B}}
